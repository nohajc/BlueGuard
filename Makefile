...
hv_driver.efi: hv_driver.o hv_handlers.o data.o rtdata.o lib_uefi.o vmx_api.o vmx_emu.o vm_setup.o regs.o reloc_pe.o smp.o ap_trampoline.o spinlock.o string.o
